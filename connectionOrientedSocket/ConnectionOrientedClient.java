...
public class ConnectionOrientedClient {
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      try {
        System.out.println("fib: " + fib(Integer.parseInt(data)));
      }
      catch (Exception e){
        System.out.println("You need to pass in an int n");
      }
...
// 2
// java ConnectionOrientedClient "This is the client" localhost